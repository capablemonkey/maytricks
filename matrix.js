...
function initConsole() {
	...
	function processInput(input) {
		commands = {
			...
			'bio': 'About Gordon:<br><br>I\'m a software engineer at Greenhouse Software. I like cycling, rock climbing, and roasting coffee.',
			'blog': openLink('http://blog.gordn.org/', 'Opening blog in new tab/window...'),
